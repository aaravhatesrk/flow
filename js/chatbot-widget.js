(function () {
  ...
  style.textContent = `
    ...
    .sc-teaser {
      ...
      background: var(--paper, #fff); color: var(--ink, #1f2430); padding: 12px 30px 12px 14px; border-radius: 14px;
    ...
    .sc-panel {
      ...
      height: 560px; max-height: calc(100vh - 48px); background: var(--paper, #fff); border-radius: 16px;
    ...
    .sc-msg.bot { background: var(--paper, #fff); color: var(--ink, #1f2430); border-bottom-left-radius: 4px; box-shadow: 0 1px 3px rgba(0,0,0,.09); white-space: normal; }
    ...
    .sc-msg.bot code { background: var(--paper-2, #eef1f6); padding: 1px 5px; border-radius: 4px; font-size: 12.5px; }
    ...
    .sc-msg.typing { background: var(--paper, #fff); color: var(--muted, #999); font-style: italic; }
    .sc-chips { display: flex; flex-wrap: wrap; gap: 6px; margin: 2px 0 10px 32px; }
    .sc-chips.sc-chips-start { margin-left: 0; }
    .sc-chip {
      background: var(--paper, #fff); border: 1.5px solid ${ACCENT}; color: ${ACCENT}; border-radius: 16px;
    ...
    .sc-input-row { display: flex; padding: 10px; border-top: 1px solid var(--line, #eee); gap: 8px; flex-shrink: 0; background: var(--paper, #fff); }
    .sc-input {
      flex: 1; border: 1px solid var(--line, #ddd); border-radius: 20px; padding: 9px 14px; font-size: 14px;
      outline: none; font-family: inherit; background: var(--paper, #fff); color: var(--ink, #1f2430);
    }
    ...
    .sc-footer {
      text-align: center; font-size: 11px; color: var(--muted, #6b7280); padding: 6px 0 10px; flex-shrink: 0; background: var(--paper, #fff);
    }
    .sc-footer a { color: inherit; text-decoration: underline; }
    .sc-feedback { display: flex; align-items: center; gap: 4px; margin: 0 0 8px 32px; font-size: 12px; color: var(--muted, #6b7280); }
    ...
    .sc-fb-btn:hover { opacity: 1; background: var(--paper-2, #eef1f6); }
